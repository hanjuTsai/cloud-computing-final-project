...
def crawl_categories():
  ...
  r = http.request(
    ...
    headers={
      "Authorization":
      "Bearer pHbUQBGRHB3mi8NG14AQx9jhLCpMOpw6xh8oIwpRhQCcOfjvZeMlBTpfwbb9KSNgRT1u-FAAep2mupH-w5TMxo60uDxuemrK33ngn-wxfq-ez7O2VeBNnSVwMARzYnYx"
    })
  ...
  for cuisine, label in categories:
    for i in range(0, 1000, 50):
      r = http.request(
        ...
        headers={
          "Authorization":
          "Bearer ZthhwvCoYQiMyZWXAGcJx9jk5ASsYWhWhtIA6hUDIkc-lHsp2o--1lpihbz9BHdnJ_YFlZEw3N6JHi_YvKPQM1t-Cd4XzUbYM7zS010kp4O_54ZnhFJw79FFw5USYnYx"
        })
